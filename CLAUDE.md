...
3. **Ao alterar `index.html`, `sw.js` ou qualquer asset, suba a versão do cache** em `sw.js`: `const CACHE = "rotina-v13"` → `"rotina-v14"`. Sem isso o navegador serve a versão antiga e a mudança parece não ter funcionado.
