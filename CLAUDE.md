...
3. **Ao alterar `index.html`, `sw.js` ou qualquer asset, suba a versão do cache** em `sw.js`: `const CACHE = "rotina-v14"` → `"rotina-v15"`. Sem isso o navegador serve a versão antiga e a mudança parece não ter funcionado.
